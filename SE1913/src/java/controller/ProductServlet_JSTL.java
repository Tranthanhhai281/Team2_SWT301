 ...
 * @author ADMIN
 */
@WebServlet(name = "ProductServlet_JSTL", urlPatterns = {"/ProductServlet_JSTL"})
public class ProductServlet_JSTL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (service.equals("deleteProduct")) {
            ...
            response.sendRedirect("ProductServlet_JSTL");
        }
...
//                request.getRequestDispatcher("ProductServlet_JSP?service=listProduct").forward(request, response);
             response.sendRedirect("ProductServlet_JSTL?service=listProduct");
            }
        ...
        if (service.equals("addProduct")) {
            ...
            if (submit == null) {//show form insert
                ...
                //Select view
                request.getRequestDispatcher("jsp/InsertProductJSTL.jsp").forward(request, response);
                ...
                //select view
                request.getRequestDispatcher("jsp/ProductJSTL.jsp").forward(request, response);
//                request.getRequestDispatcher("ProductServlet_JSP?service=listProduct").forward(request, response);
//             response.sendRedirect("ProductServlet_JSP?service=listProduct");
        ...
        if (service.equals("listProduct")) {
            ...
            //select view
            RequestDispatcher dispath = request.getRequestDispatcher("jsp/ProductJSTL.jsp");
