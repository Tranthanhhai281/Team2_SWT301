<%-- 
    ...
    Created on : Jun 20, 2025, 10:52:20 PM
    Author     : kat20
--%>
...
button.ti-trash:hover {
    ...
    <body>
        ...
        List<Teacher> list_te = tDAO.getAll();
                   Class<?> classTeacher = Teacher.class;
                    Field[] teacherAtributeArray = classTeacher.getDeclaredFields();
                     
               %>  
                
                   <table>
                       <tr>
                           <%   for (Field teacherAtribute : teacherAtributeArray) {  %>             
                           <th> <%=teacherAtribute.getName()%> </th>
                               <% } %>         
                       </tr>
                                
                             <%        
                           for(Teacher te : list_te){
                               Class<?> classTeacher2 = te.getClass();
                                 Field[] teacherAtributeArray2 = classTeacher2.getDeclaredFields();
                                 %>
                                 
                            <tr>  
                                
                           <%
                                 for (Field teacherAtribute : teacherAtributeArray2) {
                                  teacherAtribute.setAccessible(true); 
                                   Object value = teacherAtribute.get(te);  
